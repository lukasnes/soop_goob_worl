from data.code.tiles import AnimeTile, StaticTile
from data.code.support import import_folder
from data.code.settings import vertical_tiles, tile_size, screen_width
...
class Sky():
    ...
    def __init__(self,horizon,style = 'level'):
        self.top = pygame.image.load('./data/PixelArt/sky/sky_top.png')
        self.mid = pygame.image.load('./data/PixelArt/sky/sky_mid.png')
        self.bot = pygame.image.load('./data/PixelArt/sky/sky_bot.png')
        ...
        if self.style == 'overworld':
            clouds = import_folder('./data/PixelArt/overworld/decorations/clouds')
            self.clouds = []
...
class Void:
    def __init__(self,top,level_width):
        ...
        for tile in range(tile_x):
            ...
            y = top
            sprite = AnimeTile(void_width,x,y,"./data/PixelArt/void")
...
class Clouds:
    def __init__(self,horizon,level_width,count):
        clouds = import_folder('./data/PixelArt/clouds')
        min_x = -screen_width
