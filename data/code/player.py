...
class Player(pygame.sprite.Sprite):
    ...
    def import_particle_effect(self):
        self.run_effect = import_folder('./data/PixelArt/player/Particles/run')
    ...
    def invuln_timer(self):
        if self.invuln:
            curr_time = pygame.time.get_ticks()
            if curr_time - self.dmg_time >= self.invuln_frames:
                self.invuln = False
