...
class UI:
    ...
    def __init__(self,screen,curr_lvl):
        ...
        #health
        self.health_bar = pygame.image.load('./data/PixelArt/ui/health_bar.png').convert_alpha()
        self.bar_top = 50
        self.bar_left = 80
        self.bar_max_w = 89
        self.bar_h = 4
        ...
        #bacon
        self.bacon = pygame.image.load('./data/PixelArt/ui/bacon.png').convert_alpha()
            
        #egg
        self.egg = pygame.image.load('./data/PixelArt/ui/egg1.png').convert_alpha()
    ...
    def show_egg(self,collected):
        if collected:
            self.egg = pygame.image.load('./data/PixelArt/ui/egg2.png')
        else:
            self.egg = pygame.image.load('./data/PixelArt/ui/egg1.png')
